...
abstract class CreditAmountHistory implements ActiveRecordInterface
{
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCreditAccount) {
                $result['CreditAccount'] = $this->aCreditAccount->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Get the associated ChildCreditAccount object
     *
     * @param      ConnectionInterface $con Optional Connection object.
     * @return                 ChildCreditAccount The associated ChildCreditAccount object.
     * @throws PropelException
     */
    public function getCreditAccount(ConnectionInterface $con = null)
    {
        if ($this->aCreditAccount === null && ($this->credit_account_id !== null)) {
            $this->aCreditAccount = ChildCreditAccountQuery::create()->findPk($this->credit_account_id, $con);
